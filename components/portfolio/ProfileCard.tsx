...
export function ProfileCard() {
  return (
    <>
      ...
      {/* Desktop Sidebar */}
      <div
        className="hidden lg:block lg:w-56 xl:w-64 lg:fixed lg:ml-[60px] lg:left-4 xl:left-8 2xl:left-16 lg:top-8"
        style={{
          ...
          <Card className="shadow-sm bg-white rounded-xl">
            <CardContent className="p-4 space-y-5">
              ...
              <div className="text-center space-y-1">
                <h1 className="text-lg text-gray-900 font-medium leading-tight">
                  Hello I'm
                  <br />
                  Bhuvnesh Verma
                </h1>
              ...
              <div className="flex flex-col gap-2 pt-1">
                ...
                <Button
                  className="w-full bg-gray-900 hover:bg-gray-800 hover:scale-[1.02] transition-all duration-200 ease-in-out text-sm"
                  onClick={() =>
              ...
              {/* Contact info */}
              <div className="pt-3 space-y-1 border-t border-gray-100">
                <div className="flex items-center gap-2 text-gray-700 justify-center">
                  ...
                  />
                  <span className="text-xs font-medium">bhuvneshverma</span>
                </div>
              </div>
            </CardContent>
          </Card>
